...
<title>Update Custom Order</title>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
				...
				<%
					...
					ICustomService iadmin = new CustomServiceImpl();

					CustomOrder admin = iadmin.getItemValues(CID);
				%>

				
				<!-- Page Content -->

				<H3>Update Custom Order</H3>
				<hr>

				<form class="form-horizontal" action="../UpdateOrderServlet"
					...
					<fieldset class="formaddproduct">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="CID">Order
								ID</label>
							<div class="col-md-4">
								<input id="CID" name="CID"
									value="<%=admin.getCID()%>" placeholder="PRODUCT ID"
